...
const ContactUs = () => {
    ...
    const handlesubmit = async e => {
        ...
        const message = form.messagen.value
                    ...
                    <div className="lg:w-1/2 lg:mx-6">
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(254) 123-4567</span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">abc@example.com</span>
                            </p>
                        </div>
